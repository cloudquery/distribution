...
resource sa 'Microsoft.Storage/storageAccounts@2025-06-01' = if (deployResources) {
  kind: 'StorageV2'
  location: location
...
resource saUserAssigned 'Microsoft.Storage/storageAccounts@2025-06-01' = if (deployResources) {
  kind: 'StorageV2'
  location: location
